...
See https://opencode.ai/docs/rules/ and https://agents.md/#examples for
additional examples. Also read this article https://siemprelisto.cl/tecnologias/agents-md/11-generador-agentes/. Use Context7 MCP if available for any relevant
additional information needed.

## Sources of truth

- `Taskfile.yml` for the Commands section: tasks, aliases, and descriptions.
- `.opencode/commands/` for custom opencode commands (Directory layout).
...
3. Check the "Directory layout" section against tracked files; add a bullet
   for `.opencode/commands/` (custom opencode commands) if missing.
