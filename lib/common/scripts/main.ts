...
// This file is injected to the main webview
...
// This file is injected on every page
// Can be overwrited by lib/android/scripts/main.ts or lib/xcode/scripts/main.ts
