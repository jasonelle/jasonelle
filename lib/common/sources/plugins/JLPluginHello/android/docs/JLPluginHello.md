...
| File | Role |
|------|------|
| `Plugin.kt` | Native side – handles calls from JavaScript. |
...
- `Plugin.js` in `src/main/assets/plugins/hello/` – the JavaScript client, byte-identical to the Xcode plugin.