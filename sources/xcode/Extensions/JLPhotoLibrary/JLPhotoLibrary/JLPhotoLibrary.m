...
#import "JLPhotoLibraryCameraGrantedMessageHandler.h"
...
- (void) install {
    ...
    self.handlers = @{
        ...
        @"$photolibrary.camera.authorize": [[JLPhotoLibraryCameraAuthorizeMessageHandler alloc] initWithApplication:self.app andExtension:self],
        @"$photolibrary.camera.granted": [[JLPhotoLibraryCameraGrantedMessageHandler alloc] initWithApplication:self.app andExtension:self]
