...
- (void) install {
    ...
    // TODO: Setup Handlers for WebView
}

- (BOOL) granted {
    return (PHPhotoLibrary.authorizationStatus == PHAuthorizationStatusAuthorized) || (PHPhotoLibrary.authorizationStatus == PHAuthorizationStatusRestricted);
}
