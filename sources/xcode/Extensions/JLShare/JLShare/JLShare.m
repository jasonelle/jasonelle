...
@implementation JLShare

- (void) install {
    [super install];
    
    JLShareShowHandler * handlerShareShow = [[JLShareShowHandler alloc] initWithApplication:self.app andExtension:self];
    
    self.handlers = @{
        @"$share.show" : handlerShareShow,
    };
}
