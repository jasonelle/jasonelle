...
@implementation JLToastLoadingShowHandler
...
//    TODO: Maybe add duration option later
//    JLJSParams * params = [options toParams];
//    JLJSParams * opts = [params get:@"options"];
    
    [self.toaster makeToastActivity:CSToastPositionCenter];
    self.resolve(@YES);
}
@end
