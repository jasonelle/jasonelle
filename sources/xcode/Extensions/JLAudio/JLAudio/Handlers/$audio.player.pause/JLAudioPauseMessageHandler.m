...
@implementation JLAudioPauseMessageHandler
...
- (void)handleWithOptions:(nonnull JLJSMessageHandlerOptions *)options {
    ...
    int channel = [[params number:@"channel" default:@0] intValue];
    
    [ext.player pauseChannel:channel];
